...
RUN apt update
RUN apt install -y python3.9 python3.9-dev python3.9-distutils python3.8 python3.8-dev python3.8-venv python3-distutils python3.7 python3.7-dev python3.7-venv python3.6 python3.6-dev python3.6-venv python2.7 wget git
